...
let generatedparagraphs =  [generateParagraph(100)];

    function loadParagraph() {
        const ranIndex = Math.floor(Math.random() * generatedparagraphs.length);
        typingText.innerHTML = "";
        generatedparagraphs[ranIndex].split("").forEach(char => {
            console.log(char);
